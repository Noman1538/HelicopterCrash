...
//start press 'r' || 'R'
//hellicopter up press 'w'|| 'W'
//hellicopter down press 's'|| 'S'
//hellicopter speed forward press 'D' || 'd'
//hellicopter speed backward press 'A'|| 'a'
...
void gameOver(){
	...
	strcpy_s(quote[3], "Press n for New game!");
	numberOfQuotes = 5;
	glutDestroyWindow(1);
